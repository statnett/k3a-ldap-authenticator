...
public final class LdapGroupStandardAuthorizerIntegrationIT {
    ...
    public void beforeClass() {
        ...
        map.put("authorizer.class.name", LdapGroupStandardAuthorizer.class.getName());
    ...
    @Test
    public void shouldProduceOnPrefixedTopicWhenProducerByUser() {
        try (final Producer<Integer, String> producer = getProducer(LdapServer.PRODUCER_WITH_USER_ALLOW_USER_PASS)) {
    ...
    @Test
    public void shouldProduceOnPrefixedTopicWhenProducerByGroup() {
        try (final Producer<Integer, String> producer = getProducer(LdapServer.PRODUCER_WITH_GROUP_ALLOW_USER_PASS)) {
            produce(producer, PREFIXED_TOPIC_WITH_GROUP_ALLOW, "foo");
        }
    }
